...
bug: [major] (operator) Auto-keys kill-key is unreliable — pressing the configured kill-key chord doesn't always stop the cycler / recorder / playback cleanly. Flagged at end of 2026-05-10 auto-keys session (Slope C + D-3 + D-4 ship, commit 83e7cc3); not touched since. Repro context needed — likely involves focus/active-app state during the chord press.
